...
export const getCarBranchList = (offset) => {
    return dispatch => {
        let url = `${URL}/api/master-data/v1/cars/brands?limit=200&offset=0`
        fetch(url, {
            method: 'get',
            headers: {
...
export const getListCarModel = (id) => {
    return dispatch => {
        let url = `${URL}/api/master-data/v1/cars/models?brandId=${id}&limit=999`
        fetch(url, {
            method: 'get',
            headers: {
                'Content-Type': 'application/json',
...
export const getCarType = () => {
    return dispatch => {
        let url = `${URL}/api/attribute/v1/car-types?limit=200`
        fetch(url, {
            method: 'get',
            headers: {
                'Content-Type': 'application/json',
...
export const setPreviewCarImageSuccess = (data) => {
    return {
        type: SET_PREVIEW_CAR_IMAGE_SUCCESS,
        data
    }
}
export const savePreviewCarImage = (body) => {
    return dispatch => {
        dispatch(setPreviewCarImageSuccess(body))
    }
}
export const setImageFile = (data) => {
    return {
        type: SET_IMAGE_FILE,
        data
    }
}
export const saveImageFile = (body) => {
    return dispatch => {
        dispatch(setImageFile(body))
    }
}
...
export const getProvince = () => {
    return dispatch => {
        let url = `${URL}/api/master-data/v1/provinces?limit=64`
        fetch(url, {
            method: 'get',
            headers: {
                'Content-Type': 'application/json',
...
export const getDistrict = (id) => {
    return dispatch => {
        let url = `${URL}/api/master-data/v1/provinces/${id}/districts?limit=99`
        fetch(url, {
            method: 'get',
            headers: {
                'Content-Type': 'application/json',
