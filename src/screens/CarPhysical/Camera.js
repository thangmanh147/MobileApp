...
import {saveImageCarPhysical} from './actions/carPhysical';
import {RNCamera} from 'react-native-camera';
import {Color} from '../../config/System';

let { width, height } = Dimensions.get('window');

function Camera({saveImageCarPhysical}) {
    ...
    return (
        <View style={{
            ...
            <View style={{flexDirection: 'row'}}>
                {/*<TouchableOpacity*/}
                {/*    onPress={() => Platform.OS === 'ios' ? this.openLibPhotoIos() : this.openLibPhotoAndroid()}*/}
                {/*    style={{flex: 1,position:'absolute',padding:20}}>*/}
                {/*    /!*<Image style={{alignSelf: 'center', marginTop: 15, height: 20, width: 20}}*!/*/}
                {/*    /!*       source={require('../../../icons/zip.png')}/>*!/*/}
                {/*    <Text style={{color: 'white', fontSize: 10, marginTop: 10, alignSelf: 'center'}}>{'upload'}</Text>*/}
