...
function BuyerPreview({buyerInfo}) {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            {buyerInfo?.companyName && buyerInfo?.isCompany ? <View style={styles.titleContainer}>
                <View style={{flex:1}}>
            ...
            {buyerInfo?.companyTaxCode && buyerInfo?.isCompany ? <View style={styles.titleContainer}>
                <View style={{flex:1}}>
                    <Text style={styles.textStyle}>
                        Mã số thuế
                    </Text>
            ...
            {buyerInfo?.buyerGender && !buyerInfo?.isCompany ?
                <View style={styles.titleContainer}>
                <View style={{flex:1}}>
                    <Text style={styles.textStyle}>
                        Giới tính
            ...
            {buyerInfo?.buyerBirthday && !buyerInfo?.isCompany ? <View style={styles.titleContainer}>
                <View style={{flex:1}}>
                    <Text style={styles.textStyle}>
                        Ngày sinh
                    </Text>
            ...
            {buyerInfo?.buyerIdentity && !buyerInfo?.isCompany ? <View style={styles.titleContainer}>
                <View style={{flex:0.6}}>
                    <Text style={styles.textStyle}>
                        CMND/CCCD/Hộ chiếu
                    </Text>
