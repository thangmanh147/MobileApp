...
class FavorsDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isOpen:null,
    ...
    render() {
        return (
            <View style={styles.container}>
                <ImageBackground style={{height:165,width:'100%'}}>
                    <Nav isInfo={false} title={'ƯU ĐÃI ĐỔI ĐIỂM'}
                        bottom={20}
                        onPress={() => Actions.pop()}/>
                    <View style={{
                        alignSelf:'center',
                ...
                >
                    <View style={{backgroundColor: '#fff',flex: 1, borderTopLeftRadius:20,borderTopRightRadius:20}}>
                        <View style={{justifyContent:'center',alignItems:'center',flex:1}}>
                                <Text style={{color: '#414042',fontSize:16,fontWeight:'bold',textAlign:'center'}}>Bạn chắc chắn muốn đổi điểm thưởng này?</Text>
                        </View>
                        <View style={{justifyContent:'center',alignItems:'center',flex:1,flexDirection:'row'}}>
                            <TwoButton
                                label={'HỦY'}
                                labelConfirm={'ĐỔI'}
                                onPressConfirm={()=>this.openModalSuccess()}/>
                        </View>
                    </View>
                </ModalBox>
                <ModalBox
                ...
                >
                    <View style={{backgroundColor: '#fff',flex: 1, borderTopLeftRadius:20,borderTopRightRadius:20}}>
                       <View style={{justifyContent:'center',alignItems:'center',paddingTop:24}}>
                        ...
                        <View style={{justifyContent:'center',alignItems:'center',paddingTop:36,paddingHorizontal:15}}>
                            <Text style={{fontSize:14,color:'#414042',textAlign:'center'}}>Chúc mừng bạn đã đổi điểm thành công. Mã voucher của bạn sẽ được lưu lại trong mục Voucher</Text>
                       </View>
                        <View style={{justifyContent:'center',alignItems:'center',paddingTop:20,paddingHorizontal:15}}>
                            <Button label={'VOUCHER'}/>
                       </View>
                        <View style={{justifyContent:'center',alignItems:'center',paddingHorizontal:15}}>
                            <Button label={'ĐÓNG'} color={Color} backgroundColor={'#ffffff'}/>
                       </View>
                    </View>
                </ModalBox>
            </View>
