    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                    <View>
                        <Nav isInfo={false} title={'YÊU CẦU RÚT HOA HỒNG'}
                             onPress={() => Actions.pop()}/>
                    </View>
                <View style={{
                    borderRadius: 15,
                    ...
                    height:this.state.moneyInput !== '' ? 250 : 220,
                    shadowColor: "#000",
                    shadowOffset: {
                        width: 0,
                        height: 1,
                    ...
                    <TouchableOpacity onPress={()=> Actions.NodataBank()} style={{flex:1,flexDirection:'row',borderBottomWidth:1,borderColor:'#D9D9D9',marginHorizontal:10}}>
                        <View style={{justifyContent:'center'}}>
                            <FastImage source={require('../../icons/iconAgent/ic_bank.png')}
                                   style={{height:36,width:36}}/>
                        </View>
                        <View style={{justifyContent:'center',paddingLeft:10}}>
                            <Text style={{fontSize:14}}>Techcombank ****8016</Text>
                        </View>
                    ...
                    <View style={{flex:0.7,borderBottomWidth:1,borderColor:'#D9D9D9',marginHorizontal:10,flexDirection:'row'}}>
                        ...
                        <View style={{flex:1,justifyContent:'center',alignItems:'flex-end'}}>
                            <TextInput onChangeText={text => this.onChangeText(text)} placeholder={'Nhập số tiền cần rút'} style={{fontSize:14}} />
                        </View>
                    </View>
                    {
                        this.state.moneyInput !== '' ? <View style={{justifyContent:'center',paddingHorizontal:10,paddingVertical:10}}>
                            <Text style={{fontSize:14,color:'#BE3030'}}>Người nhận chịu phí chuyển khoản</Text>
                        </View> : null
                    }
                    <View style={{flex:1,paddingHorizontal:10}}>
                        <TouchableOpacity onPress={()=>this.openSuccess()} disabled={this.state.moneyInput !== '' ? false : true} style={{height:49,backgroundColor:this.state.moneyInput !== '' ? Color :'#D9D9D9',marginVertical:15,borderRadius:10,justifyContent:'center',alignItems:'center'}}>
                            <Text style={{fontSize:15,fontWeight:'bold',color:'#ffffff'}}>TIẾP TỤC</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <ModalBox
                ...
                >
                    <View style={{backgroundColor: '#fff',flex: 1, borderTopLeftRadius:20,borderTopRightRadius:20}}>
                        ...
                        <View style={{justifyContent:'center',alignItems:'center',paddingTop:24,paddingHorizontal:15}}>
                            <Text style={{fontSize:14,color:'#414042',textAlign:'center'}}>Bạn đã gửi yêu cầu rút hoa hồng thành công{'\n'}Yêu cầu của bạn sẽ được xử lý trong vòng 24h{'\n'}Nếu có vấn đề gì, bạn vui lòng liên hệ<Text style={{fontSize:14,color:'#BE3030'}}> 1900 232425</Text></Text>
                        </View>
