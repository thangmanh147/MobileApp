...
class AccidentInsuranceIntroduction extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [
  ...
  render() {
    return (
      <View style={styles.container}>
        <ScrollView>
          <FastImage
            source={require('../../icons/iconAgent/ic_TNDS_intro.png')}
        ...
        <FooterButton>
          <Button
            label={'MUA BẢO HIỂM'}
            marginTop={10}
            onPress={() => Actions.CarInfomationAccident()}
          />
        </FooterButton>
      </View>
    );
...
export default AccidentInsuranceIntroduction;
