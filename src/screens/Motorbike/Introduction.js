...
function Introduction({ permissionUser, setTokenInsur }) {
    ...
    useEffect(() => {
      new Store().getSession(Const.TOKEN).then(token => {
        let url = `${URL}/api/insured-object/v1/products/M1/channel-agents`;
        console.log('======URL', url)
        fetch(url, {
            method: 'GET',
            headers: {
    ...
    const FirstRoute = () => (
        <ScrollView style={{ paddingHorizontal: 24 }}>
            <Text style={{ fontWeight: 'bold', fontSize: 14, color: TxtColor,
                textAlign: 'justify', }}>1. Bảo hiểm Trách nhiệm dân sự bắt buộc xe máy</Text>
            ...
            <Text style={{
                ...
                Phạt tiền từ 100.000 đến 200.000 đồng đối với Người điều khiển xe mô tô, xe gắn máy, các loại xe tương tự xe mô tô và các loại xe tương tự xe gắn máy không có hoặc không mang theo Giấy chứng nhận bảo hiểm trách nhiệm dân sự của chủ xe cơ giới còn hiệu lực.{'\n'}
            ...
            <Text style={{ fontSize: 14, color: TxtColor, lineHeight: 17.5, marginTop: 7, textAlign: 'justify' }}>
    ...
    const SecondRoute = () => (
        <ScrollView style={{ paddingHorizontal: 24 }}>
            ...
            <Text style={{ fontSize: 14, color: TxtColor, lineHeight: 17.5, marginTop: 12, textAlign: 'justify' }}>
            ...
            <View style={{ flexDirection: 'row', backgroundColor: '#F6F5F6', marginTop: 6 }}>
                <View style={{
            ...
            <View style={{ flexDirection: 'row', borderBottomWidth: 1, borderColor: '#D9D9D9' }}>
                ...
                <View style={{ justifyContent: 'center', paddingHorizontal: 12, paddingVertical: 8, flex: 1.2 }}>
                    <Text style={{ fontSize: 14, color: TxtColor }}>
                        Trả theo “Bảng quy định trả tiền bồi thường thiệt hại về sức khỏe, tính mạng” (Quy định tại Nghị định số 03/2021/NĐ-CP ngày 15/01/2021 của Chính phủ).
                    </Text>
                </View>
            </View>
            <Text style={{ fontWeight: 'bold', fontSize: 14, color: TxtColor, marginTop: 12 }}>
                Bảo hiểm với tài sản:
            </Text>
            <Text style={{ marginTop: 7, fontSize: 14, color: TxtColor, lineHeight: 17.5, textAlign: 'justify' }}>
    ...
    const ThirdRoute = () => (
        <ScrollView style={{ paddingHorizontal: 24 }}>
            ...
            <Text style={{ marginTop: 7, fontSize: 14, color: TxtColor, lineHeight: 17.5, textAlign: 'justify' }}>
            - Xe mô tô 2 bánh từ 50cc trở xuống: 60.500 VNĐ/năm.{'\n'}
            - Xe mô tô 2 bánh từ trên 50 cc: 66.000 VNĐ/năm.{'\n'}
            - Xe mô tô ba bánh, xe gắn máy và các loại xe cơ giới tương tự (không bao gồm xe máy điện): 319.000 VNĐ/năm.
            </Text>
        </ScrollView>
    );
