...
class CommissionTotal extends Component {
    constructor(props) {
        super(props);
    }
...
const mapStateToProps = (state) => {
    const arr = state.commissions.dataCommission['3'] ? state.commissions.dataCommission['3'].list : [];
    const obj = state.commissions.dataCommission['3'] ? state.commissions.dataCommission['3'].options : {};
    return {
        listCommission: arr,
        options: obj,
