...
class NewModalGetPurpose extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            listPurposse: [
                { value: 'Y', label: 'Kinh doanh' },
                { value: 'N', label: 'Không kinh doanh' },
            ],
            fullData: [
                { value: 'Y', label: 'Kinh doanh' },
                { value: 'N', label: 'Không kinh doanh' },
...
export default connect(mapStateToProps)(NewModalGetPurpose);
